const portuguese = {
    ...
    'profile-about-value' : 'Atualmente sou desenvolvedor PHP e faço consultoria para a SKY (Empresa que tem como principal produto canais de televisão por assinatura.) no desenvolvimento de aplicações interativas (Aplicações que são transmitidas via satélite junto com o pacote de canais do cliente, essas aplicações podendo ser de venda de pay-per-view, marketing de novos pacotes e etc.).<br><br>Fui estagiário na SKY por 2 anos onde me desenvolvi no front-end e desenvolvi varias ferramentas de automação em Java, e atualmente sou desenvolvedor na empresa Esferas Software tendo a SKY como principal cliente.<br>.',

    'profile-name-key' : 'Nome: ',
    'profile-name-value' : 'Leonardo Pinheiro Lacerda',

    'profile-age-key' : 'Idade: ',
    'profile-age-value' : `${age} Anos`,
